...
class PersonProfile(models.Model):
    user = models.OneToOneField(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="person_profile")
    person = models.OneToOneField(Person, on_delete=models.CASCADE, related_name="profile")

    def __str__(self):
        return f"PersonProfile(user={self.user_id}, person={self.person_id})"
